...
Um aplicativo portável para o SQLite (DB Browser for SQLite Portable) pode ser encontrado [aqui](https://portableapps.com/apps/development/sqlite_database_browser_portable).
